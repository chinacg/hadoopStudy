...
public class StringPair extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StringPair\",\"namespace\":\"generated\",\"doc\":\"A pair of strings\",\"fields\":[{\"name\":\"left\",\"type\":\"string\"},{\"name\":\"right\",\"type\":\"string\"}]}");
  ...
  public static generated.StringPair.Builder newBuilder() {
    return new generated.StringPair.Builder();
  }
  
  /** Creates a new StringPair RecordBuilder by copying an existing Builder */
  public static generated.StringPair.Builder newBuilder(generated.StringPair.Builder other) {
    return new generated.StringPair.Builder(other);
  }
  
  /** Creates a new StringPair RecordBuilder by copying an existing StringPair instance */
  public static generated.StringPair.Builder newBuilder(generated.StringPair other) {
    return new generated.StringPair.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StringPair>
    ...
    private Builder() {
      super(generated.StringPair.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(generated.StringPair.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing StringPair instance */
    private Builder(generated.StringPair other) {
            super(generated.StringPair.SCHEMA$);
    ...
    /** Sets the value of the 'left' field */
    public generated.StringPair.Builder setLeft(java.lang.CharSequence value) {
    ...
    public generated.StringPair.Builder clearLeft() {
      left = null;
    ...
    /** Sets the value of the 'right' field */
    public generated.StringPair.Builder setRight(java.lang.CharSequence value) {
    ...
    public generated.StringPair.Builder clearRight() {
      right = null;
